...
setup(
    ...
    packages=['crispector2', 'crispector2.algorithm', 'crispector2.config', 'crispector2.input_processing',
              'crispector2.modifications', 'crispector2.report', 'crispector2.utils'],
