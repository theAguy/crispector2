from utils.constants_and_types import FREQ, IS_RANDOM, AVG_SCORE, SITE_NAME, ALLELE, ALIGN_SCORE, READ
import numpy as np
import pandas as pd
import math
import random
from crispector2.utils.configurator import Configurator
from input_processing.alignment import LocalLooseAlignment
