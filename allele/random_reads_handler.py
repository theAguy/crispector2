from utils.constants_and_types import IS_EDIT, FREQ, TX_READ_NUM, MOCK_READ_NUM, ON_TARGET, CUT_SITE, AlgResult, \
    PAM_WINDOW, GRNA_WINDOW, RANDOM_NUMBER, ALLELE, SNP_PHASE, RANDOM_EDIT_READS, TX_EDIT, EDIT_PERCENT, READ, CI_LOW, \
    CI_HIGH
import numpy as np
import pandas as pd
import random
...
from input_processing.alignment import align_random_df
