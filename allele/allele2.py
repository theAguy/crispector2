from utils.constants_and_types import HALF_WINDOW_LEN, LENGTH_RATIO, SNP_NUC_TYPE, FREQ, ALIGNMENT_W_DEL, LEN, \
    SNP_PHASE, IS_RANDOM, BASE, REFERENCE, ALIGN_CUT_SITE, N, AVG_SCORE, SITE_NAME, ALLELE, ALIGN_SCORE, READ, \
    CUT_SITE, RANDOM_EDIT_READS, TX_READ_NUM, TX_EDIT, PAM_WINDOW, GRNA_WINDOW, SGRNA_REVERSED, SCORE_NORM_RATE
import numpy as np
import pandas as pd
...
import math
import random
from input_processing.alignment import Alignment, LocalStrictAlignment, LocalLooseAlignment
