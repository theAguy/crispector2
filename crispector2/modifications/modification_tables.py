from crispector2.input_processing.utils import parse_cigar_with_mixed_indels
from crispector2.utils.constants_and_types import ReadsDf, DNASeq, IndelType, ExpType, ModTables, ModTablesP, IsEdit, CIGAR, FREQ, \
